...
const PLANS = [
  {
    ...
    features: ['3 protocol report credits','Full 10-step protocol wizard','AI section reviews (free)','Complete 11-document package','Download as Word (.docx) files'],
  ...
  },
  {
    ...
    perCredit: '$2.50 / report',
    highlight: true,
    badge: 'Most Popular',
    description: 'For faculty or students with multiple protocols to file.',
    features: ['10 protocol report credits','Everything in Starter','Save 17% vs Starter','Credits never expire','Priority email support'],
  ...
  },
  {
    name: 'Pro',
    price: '$55',
    per: '25 report credits',
    perCredit: '$2.20 / report',
    highlight: false,
    description: 'For labs, research centers, and heavy users.',
    features: ['25 protocol report credits','Everything in Standard','Best per-report rate','Ideal for labs & departments','Invoice/PO billing available'],
    cta: 'Buy Pro Pack',
    ctaStyle: 'border',
  },
];
