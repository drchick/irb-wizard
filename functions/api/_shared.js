/**
 * _shared.js — Cloudflare Pages Functions edition
 *
 * Shared utilities for IRB AI endpoints.
 * Underscore prefix = ignored by Cloudflare Pages router (not exposed as a route).
 *
 * Differences from api/_lib/shared.js:
 *  - No dotenv (env vars come from context.env in Cloudflare)
 *  - No getClient() — callers create the Anthropic client with context.env.ANTHROPIC_API_KEY
 */
